...
const Footer = () => {
  ...
  return (
    <div className="pt-12 md:max-w-7xl mx-auto  ">
      <footer id="footer" className="relative z-50 dark:bg-gray-900 pt-24">
        ...
        <div className="py-16 flex flex-col justify-center items-center">
          ...
          <p className="mt-6 text-xs lg:text-sm leading-none text-gray-900 dark:text-gray-50">
            2021 Hostgenie . All Rights Reserved.
          </p>
          <div>
          <Link href="https://github.com/mayureshshitole/hostginie">
           <a > <h2 className="text-blue-400">Click here for Github Repo for this UI</h2></a>
          </Link>
        </div>
        </div>
