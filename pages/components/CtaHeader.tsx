...
function CtaHead() {
  return (
    <>
      <div className="mx-auto md:max-w-7xl  py-12  ">
        <div className="w-full flex justify-center">
          <div className="w-full md:w-full bg-gradient-to-r from-indigo-500 to-indigo-700 md:py-8 md:px-8  px-5 py-4 xl:px-12 xl:py-16 rounded-3xl">
            <div>
              <div className="flex flex-wrap items-center md:flex-row flex-col-reverse">
                <div className="md:w-2/3 w-full pb-6 md:pb-0 md:pr-6 flex-col md:block flex  items-center justify-center md:pt-0 pt-4 ">
                  <h1 className="text-xl md:text-2xl lg:text-4xl xl:text-5xl lg:w-10/12 text-white font-black leading-tight md:text-left text-center ">
                    Host your web ideas with us and start building the next big thing
                  </h1>
